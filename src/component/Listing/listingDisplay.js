    ...
    const renderData = ({listData}) => {
        if(listData){
            if(listData.length > 0 ){
                        ...
                        <div className="item" key={item.restaurant_id}>
                            <div className="row">
                                <div className="col-md-5">
                                    <Link to={`/details?restId=${item.restaurant_id}`}><img src={item.restaurant_thumb} className="Image"
                                    alt={item.restaurant_name}/></Link>
                                </div>
                ...
                return(
                    <>
                        <h2 style={{textAlign:'center',color:'red',fontWeight:'600'}}>No Data For Filter</h2>
                    </>
                )
            }
        }
            ...
            return(
                <>
                    <h1 style={{textAlign:'center',color:'red',fontWeight:'600'}}>Loading.....</h1>
                </>  
            )
        }
    }
